...
/**
 * A simpler version of auto-scaling example for CloudSim
 */
public class AutoScaling {
    ...
    private static final double VM_MONITOR_INTERVAL = 10.0; // VM usage monitoring interval
    ...
    public static void main(String[] args) {
        Log.printLine("Starting Auto-Scaling Example...");
        ...
        try {
            ...
            Log.printLine("AutoScaling finished!");
